...
* **[`package.json`](file:///d:/projects/practice/reactjs/reactjs-crud/frontend/package.json)** — Manages external libraries (`react`, `react-dom`, `react-router-dom`, `axios`).
* **[`src/index.css`](file:///d:/projects/practice/reactjs/reactjs-crud/frontend/src/index.css)** — Contains global CSS rules, color tokens (`:root`), glassmorphic dark mode styles, and table styling.
