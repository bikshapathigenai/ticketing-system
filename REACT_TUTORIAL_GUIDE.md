...
3. [Phase 1: Project Setup & Tools](#3-phase-1-project-setup--tools)
...
* **[`frontend/package.json`](file:///d:/projects/practice/reactjs/reactjs-crud/frontend/package.json)** — Manages external libraries (`react`, `react-dom`, `react-router-dom`, `axios`).
* **[`frontend/src/index.css`](file:///d:/projects/practice/reactjs/reactjs-crud/frontend/src/index.css)** — Contains global CSS rules, color tokens (`:root`), glassmorphic dark mode styles, and table styling.
